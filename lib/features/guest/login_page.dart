...
class LoginPage extends StatelessWidget {
            ...
            children: [
              Column(
                children: [
                  ...
                  const SizedBox(height: 90), // เผื่อที่ไว้ให้ Bottom Nav
                ],
              ),
  ...
  // Widget สำหรับสร้างแถบเมนูด้านล่าง
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 54), // เว้นที่ให้ปุ่มโปรไฟล์ด้านขวาสุด
                ],
              ),
            ),
          ),
          // ปุ่มโปรไฟล์วงกลมที่ลอยเด่นขึ้นมา
          Positioned(
            right: 20,
            bottom: 2,
            child: Container(
...
// Widget ปุ่มกดที่ออกแบบไว้ใช้ซ้ำได้
